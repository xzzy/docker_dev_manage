...
docker run --rm --name=postgresubuntu  --mount type=bind,source=/container-data/postgres/data/,target=/data/ -p 172.17.0.1:5432:5432  -d -i -t  jasondbca/ubuntu_postgres_2004_development:1.0.11
...
docker run --rm --name=pythonwebubuntu --mount type=bind,source=/container-data/python-web-dev/data/,target=/data/ --hostname docker-webdev -p 172.17.0.1:9000-9100:9000-9100  -p 19000:19000 -p 172.17.0.1:19006:19006 -p 172.17.0.1:2222:22 --cap-add SYS_ADMIN -d -i -t --privileged=true jasondbca/ubuntu_2004_development:1.0.38
